# NeetCode Solutions — @tyagiinikunj
...
[NeetCode.io](https://neetcode.io) is a coding interview preparation platform featuring curated problems, video solutions, and an in-browser code editor. This repository is automatically populated with my accepted solutions using the **GitHub Sync** feature, as part of my DSA prep for the NeetCode 150.
...
3. **Bulk Sync** — push all past solutions at once from the GitHub settings page.
...
Working through the **NeetCode 150** in Python, one topic at a time — arrays & hashing, two pointers, sliding window, stacks, and onward through trees, graphs, and DP.

---

## Settings

Sync preferences are managed at [neetcode.io/profile/github](https://neetcode.io/profile/github):
